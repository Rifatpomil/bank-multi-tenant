...
public class BankTransferManagementSaga {
    ...
    public void on(BankTransferCreatedEvent event,
        ...
        this.tenantId = tenantId != null ? tenantId : TenantConstants.DEFAULT_TENANT;
        ...
        DebitSourceBankAccountCommand command = new DebitSourceBankAccountCommand(event.getSourceBankAccountId(),
                                                                                  ...
                                                                                  event.getAmount());
        commandBus.dispatch(asCommandMessage(command).andMetaData(metaData()), LoggingCallback.INSTANCE);
    }
    ...
    public void on(SourceBankAccountNotFoundEvent event) {
        ...
        commandBus.dispatch(asCommandMessage(markFailedCommand).andMetaData(metaData()),
    ...
    public void on(SourceBankAccountDebitRejectedEvent event) {
        MarkBankTransferFailedCommand markFailedCommand = new MarkBankTransferFailedCommand(event.getBankTransferId());
        commandBus.dispatch(asCommandMessage(markFailedCommand).andMetaData(metaData()), LoggingCallback.INSTANCE);
    }
    ...
    public void on(DestinationBankAccountNotFoundEvent event) {
        ReturnMoneyOfFailedBankTransferCommand returnMoneyCommand = new ReturnMoneyOfFailedBankTransferCommand(
                sourceBankAccountId,
                amount);
        commandBus.dispatch(asCommandMessage(returnMoneyCommand).andMetaData(metaData()), LoggingCallback.INSTANCE);
    ...
    private MetaData metaData() {
        return MetaData.with(TenantConstants.TENANT_ID_KEY, tenantId != null ? tenantId : TenantConstants.DEFAULT_TENANT);
    }
}
