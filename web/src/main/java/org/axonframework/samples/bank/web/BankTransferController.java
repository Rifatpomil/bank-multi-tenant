...
public class BankTransferController {
    ...
    public Iterable<BankTransferEntry> bankTransfers(@DestinationVariable String bankAccountId) {
        ...
        return bankTransferRepository.findByTenantIdAndSourceBankAccountIdOrTenantIdAndDestinationBankAccountId(
            tenantId, bankAccountId, tenantId, bankAccountId);
    }
    ...
    public BankTransferEntry get(@DestinationVariable String id) {
        ...
        String tenantId = TenantContext.getTenantId();
        return bankTransferRepository.findOneByTenantIdAndAxonBankTransferId(tenantId, id);
    }
